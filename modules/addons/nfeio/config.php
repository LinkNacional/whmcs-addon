...
//                     nfeio_log('nfeio', 'nfeio_get_company_info', '', $company_data['error'], '', '');
//                 } else {
...
//                 foreach (Capsule::table('tblconfiguration')->where('setting', '=', 'nfeioWhmcsAdminUrl')->get(['value', 'created_at']) as $gnfewhmcsadminurl_) {
...
//                     try {
//                         Capsule::table('tblconfiguration')->insert(['setting' => 'nfeioWhmcsAdminUrl', 'value' => $admin_url, 'created_at' => date('Y-m-d H:i:s'), 'updated_at' => date('Y-m-d H:i:s')]);
//                     } catch (\Exception $e) {
//                         $e->getMessage();
//                     }
...
//                     }
//                 }
//                 if ($nfeioWhmcsAdminUrl and ($admin_url !== $nfeioWhmcsAdminUrl)) {
//                     try {
//                         Capsule::table('tblconfiguration')->where('setting', 'nfeioWhmcsAdminUrl')->update(['value' => $admin_url, 'created_at' => $gnfewhmcsadminurl_created_at, 'updated_at' => date('Y-m-d H:i:s')]);
//                     } catch (\Exception $e) {
//                         $e->getMessage();
//                     }
//                 }
...
//             $issue_note_after_days = ['issue_note_after_days' => [
...
//             $email_nfe_config = ['email_nfe_config' => [
...
//             $cancel_invoice_cancels_nfe = ['cancel_invoice_cancels_nfe' => [
...
//             $municipal_inscri = ['municipal_inscri' => [
...
//             $desc_custom = ['custom_invoice_descri' => [
...
//             $fields = array_merge($intro, $api_key, $company_id, $service_code, $rps_serial_number, $rps_number_camp, $issue_note_default_cond, $issue_note_after_days, $email_nfe_config,$development_, $cancel_invoice_cancels_nfe, $debug, $municipal_inscri,$cpf,$cnpj, $apply_tax, $invoiceDetails, $send_invoice_url,$desc_custom, $footer);
//             $configarray = [
//                 'name' => 'NFE.io',
